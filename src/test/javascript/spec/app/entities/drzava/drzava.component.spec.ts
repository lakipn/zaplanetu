...
import { DrzavaComponent } from 'app/entities/drzava/drzava.component';
import { DrzavaService } from 'app/entities/drzava/drzava.service';
import { Drzava } from 'app/shared/model/drzava.model';

describe('Component Tests', () => {
  describe('Drzava Management Component', () => {
    let comp: DrzavaComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(DrzavaComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.drzavas[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
