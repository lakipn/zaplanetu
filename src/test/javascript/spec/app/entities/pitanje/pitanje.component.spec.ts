...
import { PitanjeComponent } from 'app/entities/pitanje/pitanje.component';
import { PitanjeService } from 'app/entities/pitanje/pitanje.service';
import { Pitanje } from 'app/shared/model/pitanje.model';

describe('Component Tests', () => {
  describe('Pitanje Management Component', () => {
    let comp: PitanjeComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(PitanjeComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.pitanjes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
