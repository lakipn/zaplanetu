...
import { OdgovorComponent } from 'app/entities/odgovor/odgovor.component';
import { OdgovorService } from 'app/entities/odgovor/odgovor.service';
import { Odgovor } from 'app/shared/model/odgovor.model';

describe('Component Tests', () => {
  describe('Odgovor Management Component', () => {
    let comp: OdgovorComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(OdgovorComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.odgovors[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
