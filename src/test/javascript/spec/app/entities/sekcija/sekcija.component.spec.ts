...
import { SekcijaComponent } from 'app/entities/sekcija/sekcija.component';
import { SekcijaService } from 'app/entities/sekcija/sekcija.service';
import { Sekcija } from 'app/shared/model/sekcija.model';

describe('Component Tests', () => {
  describe('Sekcija Management Component', () => {
    let comp: SekcijaComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(SekcijaComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.sekcijas[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
